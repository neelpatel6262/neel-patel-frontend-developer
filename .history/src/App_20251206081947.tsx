...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen overflow-x-hidden bg-background text-foreground selection:bg-primary/30 selection:text-primary transition-colors duration-300">
        ...
        <footer className="relative py-12 px-4 md:px-8 border-t border-border bg-background">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            >
              © 2025 Neel Patel. <span className="text-muted-foreground/60">All Systems Nominal.</span>
            </motion.div>
