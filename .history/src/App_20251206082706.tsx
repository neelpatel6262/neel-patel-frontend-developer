...
export default function App() {
  ...
  return (
    <>
      ...
      <div className={`relative min-h-screen overflow-x-hidden text-foreground selection:bg-[var(--primary)]/30 selection:text-[var(--primary)] transition-colors duration-300 ${theme === 'light' ? 'bg-white' : 'bg-[#131313]'}`}>
        ...
        {/* Footer */}
        <footer className={`relative py-12 px-4 md:px-8 border-t ${theme === 'light' ? 'border-gray-300 bg-white' : 'border-[#333] bg-[#131313]'}`}>
            ...
            >
                {[
                    ...
                    <a 
                        ...
                        className={`transition-colors duration-300 ${theme === 'light' ? 'text-gray-700 hover:text-[var(--primary)]' : 'text-[#939393] hover:text-[var(--primary)]'}`}
                    >
