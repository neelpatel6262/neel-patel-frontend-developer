  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed right-0 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center gap-6 py-8 px-3 bg-[#131313] border-l border-y border-[#333] hover:border-[var(--primary)] transition-all duration-300 group shadow-lg"
      >
        <span 
          className="text-xs font-mono font-medium tracking-[0.2em] text-[#939393] group-hover:text-[var(--primary)] transition-colors uppercase rotate-180 whitespace-nowrap"
          style={{ writingMode: 'vertical-rl' }}
        >
          Contact
        </span>
        <div className="w-[1px] h-8 bg-[#333] group-hover:bg-[var(--primary)] transition-colors" />
        <MessageSquare className="w-4 h-4 text-[#939393] group-hover:text-[var(--primary)] transition-colors" />
      </motion.button>
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 z-50 w-full max-w-md bg-[#131313] border-l border-[#333] shadow-2xl p-0 flex flex-col"
            >
              {/* Header */}
