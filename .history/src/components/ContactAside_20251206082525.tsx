            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-8">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className={`w-full py-4 border font-mono uppercase tracking-widest transition-all duration-300 ${theme === 'light' ? 'border-[var(--primary)] text-[var(--primary)] bg-transparent hover:bg-[var(--primary)] hover:text-white' : 'border-[var(--primary)] text-[var(--primary)] bg-transparent hover:bg-[var(--primary)] hover:text-[#131313]'}`}
                  >
                    Send Transmission
                  </button>
                </form>
