...
export function MobileNav({ theme = 'dark', toggleTheme }: MobileNavProps) {
  ...
  return (
    ...
    >
      <div className={`flex items-center justify-between px-4 py-4 rounded-lg backdrop-blur-xl shadow-2xl ${theme === 'light' ? 'bg-white/90 border border-gray-300' : 'bg-[#131313]/90 border border-[#333]'}`}>
        ...
        <div className={`pl-4 border-l ${theme === 'light' ? 'border-gray-300' : 'border-[#333]/30'}`}>
